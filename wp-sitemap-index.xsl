			...
			<body>
				<div id="sitemap">
					<div id="sitemap__header">
						<h1>XML 站点地图</h1>
						<p>此 xml 站点地图是由 WordPress 生成的，以使您的内容在搜索引擎中更加可见。</p>
						<p><a href="https://www.sitemaps.org/">了解有关 xml 站点地图的更多信息。</a></p>
					</div>
					<div id="sitemap__content">
						<p class="text">此 xml 站点地图中的 URL 数：<xsl:value-of select="count( sitemap:sitemapindex/sitemap:sitemap )" />。</p>
